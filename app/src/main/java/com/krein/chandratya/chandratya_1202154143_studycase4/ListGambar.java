package com.krein.chandratya.chandratya_1202154143_studycase4;
...
public class ListGambar extends AppCompatActivity {
        ...
        imageDownloaderButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(downloadUrl.isEmpty()){
                    ...
                    Toast.makeText(ListGambar.this,"Masukkan URL gambar terlebih dahulu",Toast.LENGTH_SHORT).show();
                }else {
    ...
    private class ImageDownloader extends AsyncTask<String, Void, Bitmap> {
        ...
        protected void onPreExecute() {
            ...
            mProgressDialog = new ProgressDialog(ListGambar.this);
